...
import { Content42 } from "./Content42";
import { Content43 } from "./Content43";

const CONTENT = [
  {
    title: "Sąlygų atnaujinimas",
    content: <Content41 />,
  },
  {
    title: "Paskyros sustabdymas, išjungimas",
    content: <Content42 />,
  },
  {
    title: "Ginčai",
...
export class Content4 extends Component {
  state = {
    activeSections: [],
    collapsed: true,
    multipleSelect: true,
      ...
      <>
        ...
        >
          <Text
            style={[
              styles.headerText,
              { flex: 1, textAlign: "left", paddingLeft: 30 },
            ]}
          >
            {section.title}
          </Text>
